 ...
 *
 */
public abstract class DescriptionObject<ReturnedK> {
	public enum DescriptiveType {
		...
		private DescriptiveType(String descr) {
			this.typeStr = descr;
		}
	}

	protected DescriptiveType description;
	 ...
	 */
	protected DescriptionObject(DescriptiveType description){
	...
	public DescriptiveType getDescription(){
		return description;
	}
	@Override
	public int hashCode(){
